{{-- Inner grid for #products-section — shared by explorestore view + AJAX --}}
   ...
   <div class="col-md-3 pb-4 col-6">
      <div class="item">
         <div class="product-card p-0">
            ...
            <img src="{{ $defaultVariant ? $defaultVariant->displayImageUrlForProduct($product) : ($product->featureImage ? asset('public/' . $product->featureImage->feature_image) : asset('public/assets/website/images/default.png')) }}"
