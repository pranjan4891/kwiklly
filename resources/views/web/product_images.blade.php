                                ...
                                <tbody>
                                    @foreach ($productImages as $key => $product)
                                        <tr>
                                           ...
                                           <td>
                                                @if ($isDeletedView)
                                                    <span class="text-muted">Only admin can restore or erase</span>
                                                @else
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                @if(!empty($product->product_images))
                                                                    <div class="clearfix mb-2" style="max-height: 160px; overflow-y: auto; border: 1px solid #eee; padding: 8px; border-radius: 4px;">
                                                                        <small class="text-muted d-block mb-1">Current images (add more below)</small>
                                                                        <div class="row">
                                                                            @foreach ($product->product_images as $img)
                                                                                <div class="col-xs-4 col-sm-3 mb-2 text-center">
                                                                                    <img src="{{ asset('public/' . $img) }}" alt="" class="img-thumbnail" style="max-width: 100%; max-height: 70px; object-fit: contain;">
                                                                                </div>
                                                                            @endforeach
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <small>Optional: upload additional images. Only admin can remove images (View).</small>
                                                            </div>
