    ...
    <div class="invoice-container">
        ...
        <div class="header-section">
            <div class="top-right">
                ...
                <div class="invoice-number">Invoice Number # {{ strtoupper($order->order_number) }}</div>
            </div>
...
@php
    $vendor = $order->vendorOrders->first()->vendor ?? null;
...
@endphp
        ...
        <div class="items-section">
            <div class="total-items">Total items: {{ $order->vendorOrders->sum(function($vo) { return $vo->orderItems->count(); }) }}</div>
