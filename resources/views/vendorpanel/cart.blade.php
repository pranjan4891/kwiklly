        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @else
                        <form method="POST" action="{{ route('vendor.cart.update') }}">
                            @csrf
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($cartItems as $index => $item)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('public/' . $item->product->featureImage->feature_image ?? 'noimage.png') }}" alt="Product Image" style="width: 80px;">                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="{{ route('vendor.cart.remove', $item->id) }}" class="btn btn-danger" title="Remove" onclick="return confirm('Remove this item?')">
                            ...
                            <div class="text-right mt-3">
                                ...
                                <a href="{{ route('vendor.products') }}" class="btn btn-default">Back to Products</a>
                            </div>
                        </form>
                    @endif
                </div>
