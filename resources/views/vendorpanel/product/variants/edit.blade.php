        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('vendor.product.variant.update', $variant->id) }}" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="mb-3">
                                        @foreach($variant->images as $img)
                                            <span class="d-inline-block mr-2 mb-2" style="position:relative;">
                                                ...
                                                <a href="{{ route('vendor.product.variant.image.delete', $img->id) }}" class="btn btn-xs btn-danger" style="position:absolute; top:-8px; right:-8px;" onclick="return confirm('Remove this image?')">×</a>
                                            </span>
                                        @endforeach
                                    </div>
                                @endif
