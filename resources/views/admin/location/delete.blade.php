      ...
      <div class="col-md-12">
         ...
         <div class="panel panel-default">
            <div class="panel-heading">
               <div class="row">
                  <div class="col-sm-6">
                     <h3 class="panel-title">Deleted Pincode Locations</h3>
                  </div>
                              ...
                              <table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          {{-- <a href="{{ route('admin.location.restore', $location->id) }}" class="btn btn-success tooltips" title="Restore">
                                          <i class="fa fa-undo"></i>
                                          </a> --}}
                                            <form action="{{ route('admin.location.restore', $location->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('POST')
                                                <button class="btn btn-success tooltips" title="Restore">
                                                <i class="fa fa-undo"></i>
                                                </button>
                                          </form>
                                          <form action="{{ route('admin.location.destroy', $location->id) }}" method="POST" style="display:inline;">
                                             @csrf
                                             @method('DELETE')
                                             <button class="btn btn-danger tooltips" title="Permanent Delete" onclick="return confirm('Are you sure want to delete parmanent?')">
