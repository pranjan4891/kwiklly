                                ...
                                @foreach ($products as $index => $product)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('admin.product.trending.bestoffers', $product->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure to delete this product?');">
                                                @csrf
                                                @method('POST')
