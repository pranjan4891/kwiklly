        ...
        <div class="page-title">
            <h3 class="welcome-header">
                ...
                <span class="vendor_dash">
                    <a href="{{route('branch.login')}}" class="btn btn-primary btn-sm" target="_blank">Department Dashboard</a>
                </span>
            </h3>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="widget-panel widget-style-2" style="background-color: #1cc88a; color: white;">
                    ...
                    <h2 class="m-0 counter">{{ $vendor }}</h2>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="widget-panel widget-style-2" style="background-color: #36b9cc; color: white;">
                    ...
                    <h2 class="m-0 counter">{{ $customer }}</h2>
            ...
            <!-- Total Categories -->
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="widget-panel widget-style-2" style="background-color: #6f42c1; color: white;">
                    <i class="fas fa-tags"></i>
                    <h2 class="m-0 counter">{{ $totalCategory }}</h2>
                    <div><strong>Total Categories</strong></div>
                </div>
            </div>

            <!-- Total Sub-Categories -->
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="widget-panel widget-style-2" style="background-color: #fd7e14; color: white;">
                    <i class="fas fa-tag"></i>
                    <h2 class="m-0 counter">{{ $totalSubCategory }}</h2>
                    <div><strong>Total Sub-Categories</strong></div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.products') }}" class="btn btn-sm btn-outline-primary">View More <i class="fas fa-arrow-right ms-1"></i></a>
                    </div>
