...
<!-- START BREADCRUMB -->
<ul class="breadcrumb">
    <li><a href="{{ route('branch.dashboard') }}">Home</a></li>
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form">
                        <form class="cmxform form-horizontal tasi-form" method="get" action="{{ route('branch.orderlist') }}">
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    ...
                                    <a href="{{ route('branch.orderlist') }}" class="btn btn-default">
                            ...
                            <tbody>
                                @forelse($orderDetails as $key)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('branch.order.details', $key->vendor_order_id) }}"
                                            ...
                                            <a href="{{ route('branch.order.download.invoice', $key->vendor_order_id) }}"
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                function updateOrderStatus(orderId, status) {
                    ...
                    //var branchOrderUpdateStatusRoute = "{{ route('branch.order.update.status', ':id') }}".replace(':id', orderId);
                        $.ajax({
                            url: '{{ route("branch.order.update.status", ":id") }}'.replace(":id", orderId),
                            type: 'POST',
                            data: {
                                status: status,
                                _token: '{{ csrf_token() }}',
