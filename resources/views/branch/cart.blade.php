        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @else
                        <form method="POST" action="{{ route('branch.cart.update') }}">
                            @csrf
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="{{ route('branch.cart.remove', $item->id) }}" class="btn btn-danger" title="Remove" onclick="return confirm('Remove this item?')">
                            ...
                            <div class="text-right mt-3">
                                ...
                                <a href="{{ route('branch.products') }}" class="btn btn-default">Back to Products</a>
                            </div>
                        </form>
                    @endif
                </div>
