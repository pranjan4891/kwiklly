                            ...
                            <tbody>
                                @foreach ($products as $index => $product)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('branch.product.edit', $product->id) }}" class="btn btn-primary btn-sm" title="Edit">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <form action="{{ route('branch.product.destroy', $product->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure to delete this product?');">
                                                @csrf
                                                @method('DELETE')
