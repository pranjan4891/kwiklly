        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="variant-create-info">
                        <strong>Process:</strong> Ek variant = ek color. Pehle variant base (e.g. 8/256) aur price set karein. Phir har color ke liye Color select karein, images upload karein, aur <strong>us color ka Stock</strong> dalen. Add color se aur colors add karein. Save par har color alag variant banega — isse color-wise stock maintain hota hai.
                    </div>
                @if(session('success'))
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('branch.product.variant.store') }}" id="variantForm" enctype="multipart/form-data">
                        @csrf
                        ...
                        @else
                        {{-- No Color attribute: single-variant form --}}
                        <div class="form-group">
