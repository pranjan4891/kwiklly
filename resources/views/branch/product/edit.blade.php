...
@section('main')
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="{{ route('branch.product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                          ...
                          <div class="col-md-12" id="physicalProductFields" style="display: none;">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="cgst" class="form-control" step="0.01" value="{{ $product->cgst }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="sgst" class="form-control" step="0.01" value="{{ $product->sgst }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <a class="btn btn-warning btn-sm ml-2" href="{{ route('branch.product.images') }}" target="_blank">Upload New Image</a>
    ...
    {{-- Feature Image Modal --}}
    @include('branch.product.partials.image-modal', ['images' => $images])
@endsection
...
<script>
    $('#category_id').on('change', function () {
        ...
        if (categoryId) {
            $.ajax({
                url: '{{ route("branch.getSubcategories") }}',
                method: 'GET',
