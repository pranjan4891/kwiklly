...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('vendorpanel.product.create', compact('title', 'vendor', 'categories', 'images', 'attributes'));
    }
    ...
    public function updateVariant(Request $request, $id)
    {
        ...
        return redirect()->route('vendor.product.variant.create', $variant->product_id)->with('success', 'Variant updated successfully.');
    }
    ...
    public function deleteVariantImage($id)
    {
        ...
        $image->delete();
        return redirect()->route('vendor.product.variant.edit', $variantId)->with('success', 'Image removed.');
    }
