...
class OrderController extends Controller
{
    public function orderlist(Request $request)
    {
        ...
        return view('branch.order.list', compact('title','branch','orderDetails', 'vendorOrders'));
    }
    ...
    public function orderDetails($orderId)
    {
        ...
        $title="Order Details | Branch Panel";
        ...
        return view('branch.order.details', compact('vendorOrder', 'branch', 'title'));
    }
    ...
    public function downloadInvoice($orderId)
    {
        ...
        $pdf = Pdf::loadView('branch.order.invoice', compact('vendorOrder'));
