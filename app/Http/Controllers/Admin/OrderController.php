...
class OrderController extends Controller
{
    public function orderlist(Request $request)
    {
        ...
        // Get all vendor orders for admin
        ...
        $orderDetails = $vendorOrders->map(function ($vendorOrder) {
            ...
            return (object) [
                ...
                'feld_vendor_name' => $vendorOrder->vendor->name ?? 'N/A',
        ...
        return view('admin.order.list', compact('title','admin','orderDetails', 'vendorOrders'));
    }
    ...
    public function orderDetails($orderId)
    {
        ...
        return view('admin.order.details', compact('vendorOrder', 'admin', 'title'));
    }
