...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        $products = Product::with(['category', 'subcategory', 'vendor', 'featureImage'])->get();
        return view('admin.product.index', compact('products', 'title', 'admin'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.product.create', compact('title', 'admin', 'categories', 'images', 'attributes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $product = new Product();
        $product->vendor_id = auth()->guard('admin')->id();
    ...
    public function edit($id)
    {
        ...
        return view('admin.product.edit', compact('title', 'admin', 'product', 'categories', 'images', 'attributes', 'subcategories'));
    }
    ...
    public function editVariant($id)
    {
        ...
        return view('admin.product.variants.edit', compact('title', 'admin', 'variant', 'product', 'attributes'));
    }
    ...
    public function deleteVariantImage($id)
    {
        ...
        $image->delete();
        return redirect()->route('product.variant.edit', $variantId)->with('success', 'Image removed.');
    }
